...
import { handleEvaluationAction, loadEvaluationsFeature } from './features/evaluations.js';
...
async function loadTabData(tab) {
  switch (tab) {
    ...
    case 'evaluations': await loadEvaluationsFeature(); break;
...
async function handleDashboardAction(event) {
  ...
  if (!trigger) return;
  if (await handleEvaluationAction(event, trigger)) return;
