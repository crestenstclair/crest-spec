...
func generateCUE(files []classifiedFile, language string) string {
	...
	b.WriteString("\tmission: \"TODO: describe the users, intended outcome, and architectural constraints\"\n")
	b.WriteString("\tactors: developer: {description: \"TODO: replace with the actual target user or system actor\"}\n")
	b.WriteString("\tgoals: imported_behavior: {\n")
	b.WriteString("\t\tdescription: \"TODO: replace with the required user-visible outcome\"\n")
	b.WriteString("\t\tpriority: \"required\"\n")
	b.WriteString("\t\tactors: [\"actor.developer\"]\n")
	b.WriteString("\t\tcapabilities: [\"capability.imported_capability\"]\n")
	b.WriteString("\t\trequirements: [\"requirement.imported_requirement\"]\n")
	b.WriteString("\t}\n")
	b.WriteString("\tcapabilities: imported_capability: {\n")
	b.WriteString("\t\tdescription: \"TODO: describe the observable functionality represented by the imported resources\"\n")
	b.WriteString("\t\tgoals: [\"goal.imported_behavior\"]\n")
	b.WriteString("\t\tacceptance: imported_acceptance: {description: \"TODO: define an executable acceptance scenario\", actor: \"actor.developer\", evidence: [\"evidence.imported_evidence\"]}\n")
	b.WriteString("\t}\n")
	b.WriteString("\trequirements: imported_requirement: {kind: \"functional\", description: \"TODO: define the functional requirement\", goals: [\"goal.imported_behavior\"], capabilities: [\"capability.imported_capability\"]}\n")
	b.WriteString("\tevidence: imported_evidence: {kind: \"definition_required\", description: \"TODO: define validation or behavioral evidence before completion\"}\n")
	b.WriteString("\tcompletion: requiredGoals: [\"goal.imported_behavior\"]\n")
